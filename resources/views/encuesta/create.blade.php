                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content bg-white">
                      <div class="modal-header">
                        <h4 class="modal-title">Seguir con el protocolo</h4>
 ...
 <table class="table table-condensed table-hover" id="infopersonal">
     ...
     <tbody>
         <tr>
             ...
             <lu>
                 <li><strong>Nombre:</strong> {{$empleados->FullName}}</li>
                 <li><strong>Ingresa como:</strong> {{$empleados->CARGO}}</li>
         ...
         <tr>
             <td>
                 <lu id="tipotrabajo">
                     <li><strong>Lugar donde se dirige:</strong> {{$tipotrabajo2}}</li>
                     <li><strong>Tipo de trasporte:</strong> {{$transportes}}</li>
                 </lu>
