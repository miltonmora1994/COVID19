    ...
    */
    public function collection()
    {
         return $index = \DB::table('encuesta')
                ...
                ->where('Covid19','No' )
                ->select('encuesta.*', 'empleados.CEDULA', 'empleados.NOMBRE', 'empleados.APELLIDO','empleados.EMPRESA','empleados.CARGO','empleados.DIRECCION','empleados.TELEFONO','empleados.FECNAC','empleados.SEXO')
        		->get();
